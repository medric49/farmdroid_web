...
class FileManager
{
    ...
    public static function loadAvatar(User $user,$format="256") {
        return self::loadImage($user->avatar,config("farmdroid.avatar_path"),$format);
    }
    public static function storeAvatar(UploadedFile $image) {
        return self::storeImage($image,config("farmdroid.avatar_path"));
    }
